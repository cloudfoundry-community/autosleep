...
public class AutoSleepServiceBindingTest {
    ...
    private AutoSleepServiceBinding getNewBinding() {
        return new AutoSleepServiceBinding(SERVICE_DEFINITION_ID,SERVICE_ID,new HashMap<>(),APP,LOG_URL);
    }
